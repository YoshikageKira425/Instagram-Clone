<?php
$path = GetTheUrlValue(1);
$hasNewMessages = $messageController->newMessages($user['id']);
?>
        ...
        <ul class="space-y-2 px-2">
                ...
                <a href="/Instagram_Clone/creatingPost.php" class="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-neutral-800 transition">
                    <svg aria-label="New post" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
                        ...
                        <?php else: ?>
                            ...
                            <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" x1="6.545" x2="17.455" y1="12.001" y2="12.001"></line>
                            <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" x1="12.003" x2="12.003" y1="6.545" y2="17.455"></line>
                        <?php endif; ?>
                    </svg>
            ...
            <li>
                <a href="/Instagram_Clone/accounts.php/<?= $user["url"] ?>" class="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-neutral-800 transition">
                    <img src="<?= $user["profile_image"] ?>" alt="User" class="w-9 h-9 rounded-full <?= $path == "accounts.php" && GetTheUrlValue() == $user["url"] ? "border-white border-2" : "" ?>">
            ...
            <?php if ($user["role"] === "Admin"): ?>
                <li>
                    <a href="/Instagram_Clone/admin.php" class="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-neutral-800 transition text-white">
                        ...
                        <span class="hidden lg:block font-medium text-white">Admin</span>
                    </a>
                </li>
            <?php endif; ?>
        </ul>
