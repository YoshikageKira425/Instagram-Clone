            ...
            <?php foreach ($posts as $post): ?>
                <div class="max-w-md text-white border border-gray-800 rounded-lg shadow mb-6">
                    <div class="flex items-center justify-between px-4 py-3">
                        <a href="/Instagram_Clone/accounts.php/<?= "m" ?>" class="flex items-center space-x-3">
                    ...
                    <a href="/Instagram_Clone/post.php/<?= $post["id"] ?>" class="block">
                        <img src="<?= $post["image"] ?>" alt="Post Image" class="w-full object-cover max-h-[500px]">
                    </a>

                    <div class="px-4 py-3">
                        <div class="flex items-center space-x-4" method="post">
